        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Organization = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Location = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    JobType = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    SalaryRange = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    TagsCsv = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParsedSkillsCsv = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ParsedByAi = table.Column<bool>(type: "bit", nullable: false),
                    ParsedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ParsedEngine = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ParsedModel = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatThreads_AspNetUsers_JobSeekerId",
                        column: x => x.JobSeekerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatThreads_AspNetUsers_RecruiterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JobId = table.Column<int>(type: "int", nullable: false),
                    ApplicantUserId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatThreads_JobSeekerId",
                table: "ChatThreads",
                column: "JobSeekerId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatThreads_RecruiterId",
                table: "ChatThreads",
                column: "RecruiterId");
